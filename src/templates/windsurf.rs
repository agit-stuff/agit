//! Windsurf instruction template.

/// Template content for `.windsurfrules`.
///
/// This file is read by Windsurf as project-specific agent rules.
pub const WINDSURFRULES_TEMPLATE: &str = r#"# Windsurf Rules for AGIT
